...
class Cupidon(Villageois):
    def __init__(self, player_name):
        ...
        self.text_info = "« Avec sa précision surhumaine, l’Ange de Noël va tirer sa flèche au ralenti pour emmener en calèche les deux cœurs conquis en lune de miel. Il est digne d’être le remplaçant de cupidon durant la saison hivernale ! »"
