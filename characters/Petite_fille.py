...
class Petite_fille(Villageois):
    def __init__(self, player_name):
        ...
        self.text_info = "« *Qui pourrait se méfier d’Olaf sur le fait qu’il soit peut-être la petite fille espionnant les Grinch-Garous du coin de son œil ? Personne ! Ce rôle lui ira comme un gant. » Tiré du film La Reine des Neiges"
